...
namespace PruebaIngreso
{
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        private void ProviderMargin(IServiceContainer container)
        {
           /* container.Register<IClientProvider, ClientProvider>();
                container.RegisterSingleton<IMarginProvider, Margin>("Special");*/
